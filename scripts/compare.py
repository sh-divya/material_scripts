...
if __name__ == "__main__":
    ...
    results_fptr = [
        "train_ngen10_steps250_m3gnet_results.csv",
        "train_ngen10_steps500_m3gnet_results.csv",
        "train_ngen5_steps250_m3gnet_results.csv",
        "train_ngen5_steps500_m3gnet_results.csv"
        ]
    nsamples = 100
